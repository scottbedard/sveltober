...
<Router>
    <!-- nav -->
    <ul class="mb-8">
        <li><NavLink to="first">Today I did something cool</NavLink></li>
        <li><NavLink to="second">I did something awesome today</NavLink></li>
        <li><NavLink to="third">Did something sweet today</NavLink></li>
    </ul>
